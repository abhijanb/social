...
import { sessionPurge } from "./sessionPurge.job.js";
...
// Story view digest runs hourly; purge jobs fire daily at 02:00.
export const schedules: DefinedSchedule[] = [storyViewDigest, storyExpiry, softDeletePurge, sessionPurge];
